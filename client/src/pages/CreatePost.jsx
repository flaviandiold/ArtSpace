...
const CreatePost = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (form.prompt && form.photo) {
      ...
      alert('Please have a generated image with its prompt');
    }
  }
  ...
  return (
    <section className="max-w-7xl mx-auto">
      <div>
        ...
        <p className="mt-2 text-[#665e75] text-[14px] max-w-[500px]">Create imaginative images and share them with the community</p>
      </div> 
